...
Public Class Form_Modificar_Puntos_Registro
    ...
    'Tipo_Onda = 0 es una Onda P
    'Tipo_Onda = 1 es una Onda QRS
    'Tipo_Onda = 2 es una Onda T
    Const Onda_P = 0
    Const Onda_QRS = 1
    Const Onda_T = 2
    ...
    Dim Tipo_Onda_P_T() As String = {"Onda_Plana", "Onda_P", "Onda_N", "Onda_B_PP_N", "Onda_B_P_N", "Onda_B_P_NN", "Onda_B_NN_P", "Onda_B_N_P", "Onda_B_N_PP", "Onda_C_P", "Onda_C_N"}
    ...
    Public Sub Form_Registro_Parciales_Modificar(Form_Invocador_1 As Form, UserControl_Modulo_Graficar_Invocador_1 As UserControl_Modulo_Graficar, Accion_Modificar As Boolean, Tipo_Onda As Int16, Ubicacion_Tabla As Int16, Optional Dato_ComboBox As Int16 = 0, Optional Dato_1 As Double = 0, Optional Dato_2 As Double = 0, Optional Dato_3 As Double = 0, Optional Dato_4 As Double = 0, Optional Dato_5 As Double = 0)
        ...
        If Accion_Modificar = True Then
            If Tipo_Onda = Onda_P Then
                NumericUpDown_Dato_1.Value = Dato_1
                NumericUpDown_Dato_2.Value = Dato_2
                NumericUpDown_Dato_3.Value = Dato_3
                NumericUpDown_Dato_4.Visible = False
                NumericUpDown_Dato_5.Visible = False
                Label_Dato_1.Text = "P_i"
                Label_Dato_2.Text = "P"
                Label_Dato_3.Text = "P_f"
                Label_Dato_4.Visible = False
                Label_Dato_5.Visible = False
                ComboBox_Tipo_Onda_Modificar.Items.Clear()
                ComboBox_Tipo_Onda_Modificar.Items.AddRange(Tipo_Onda_P_T)
                ComboBox_Tipo_Onda_Modificar.SelectedIndex = Dato_ComboBox

            ElseIf Tipo_Onda = Onda_QRS Then
            ...
            ElseIf Tipo_Onda = Onda_T Then
                NumericUpDown_Dato_1.Value = Dato_1
                NumericUpDown_Dato_2.Value = Dato_2
                NumericUpDown_Dato_3.Value = Dato_3
                NumericUpDown_Dato_4.Visible = False
                NumericUpDown_Dato_5.Visible = False
                Label_Dato_1.Text = "T_i"
                Label_Dato_2.Text = "T"
                Label_Dato_3.Text = "T_f"
                Label_Dato_4.Visible = False
                Label_Dato_5.Visible = False
                ComboBox_Tipo_Onda_Modificar.Items.Clear()
                ComboBox_Tipo_Onda_Modificar.Items.AddRange(Tipo_Onda_P_T)
    ...
    Public Sub Actualizar_Char_Registro_Modificar()
        ...
        If Registro_Modificar_1.Nombre_Tabla <> Nothing Then
            ...
            If Form_Principal.Estado_Registros.Consultar_Registro_Bloqueado(Registro_Modificar_1.Nombre_Tabla) = False Then
                ...
                If Registro_Modificar_1.Tipo_Onda = Onda_P Then
                    'Creo los dataset
                    ...
                    If NumericUpDown_Dato_1.Text <> "" And ((NumericUpDown_Dato_1.Value) > Zoom.X_Inicio And (NumericUpDown_Dato_1.Value) < Zoom.X_Final) Then
                        'Creo las series
                        x_P_i = (NumericUpDown_Dato_1.Value)
                        y_P_i = Datos_Registro.Tables(0).Rows(x_P_i * Registro_Frecuencia - Datos_Registro.Tables(0).Rows(0)(0))(1)
                        'Adiciono las series a la grafica
                        'Actualiza Series_Max Para que se vea al frente
                        Chart_Registro_Parcial.Series.Add(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_i")
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_i").ChartType = DataVisualization.Charting.SeriesChartType.Point
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_i").Points.AddXY(x_P_i, y_P_i)
                        '  Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_i").MarkerImage = "C:\Users\Frank\Dropbox\Dropbox\Bohíque_FMS\Bohíque_FMS\Imagenes\" + TreeView_Graficar.Nodes(Index_TreeView_0).Nodes(Index_TreeView_1).ImageKey
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_i").Color = Color.Red
                    ...
                    If NumericUpDown_Dato_2.Text <> "" And ((NumericUpDown_Dato_2.Value) > Zoom.X_Inicio And (NumericUpDown_Dato_2.Value) < Zoom.X_Final) Then
                        'Creo las series
                        x_P = (NumericUpDown_Dato_2.Value)
                        y_P = Datos_Registro.Tables(0).Rows(x_P * Registro_Frecuencia - Datos_Registro.Tables(0).Rows(0)(0))(1)
                        'Adiciono las series a la grafica
                        'Actualiza Series_Max Para que se vea al frente
                        Chart_Registro_Parcial.Series.Add(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P")
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P").ChartType = DataVisualization.Charting.SeriesChartType.Point
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P").Points.AddXY(x_P, y_P)
                        '  Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P").MarkerImage = "C:\Users\Frank\Dropbox\Dropbox\Bohíque_FMS\Bohíque_FMS\Imagenes\" + TreeView_Graficar.Nodes(Index_TreeView_0).Nodes(Index_TreeView_1).ImageKey
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P").Color = Color.Black
                    End If
                    If NumericUpDown_Dato_3.Text <> "" And ((NumericUpDown_Dato_3.Value) > Zoom.X_Inicio And (NumericUpDown_Dato_3.Value) < Zoom.X_Final) Then
                        'Creo las series
                        x_P_f = (NumericUpDown_Dato_3.Value)
                        y_P_f = Datos_Registro.Tables(0).Rows(x_P_f * Registro_Frecuencia - Datos_Registro.Tables(0).Rows(0)(0))(1)
                        'Adiciono las series a la grafica
                        'Actualiza Series_Max Para que se vea al frente
                        Chart_Registro_Parcial.Series.Add(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_f")
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_f").ChartType = DataVisualization.Charting.SeriesChartType.Point
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_f").Points.AddXY(x_P_f, y_P_f)
                        '  Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_f").MarkerImage = "C:\Users\Frank\Dropbox\Dropbox\Bohíque_FMS\Bohíque_FMS\Imagenes\" + TreeView_Graficar.Nodes(Index_TreeView_0).Nodes(Index_TreeView_1).ImageKey
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "P_f").Color = Color.Blue
                    End If
                ...
                End If
                If Registro_Modificar_1.Tipo_Onda = Onda_T Then
                    Dim y_T_i, y_T, y_T_f As Double
                    Dim x_T_i, x_T, x_T_f As Double
                    If NumericUpDown_Dato_1.Text <> "" And ((NumericUpDown_Dato_1.Value) > Zoom.X_Inicio And (NumericUpDown_Dato_1.Value) < Zoom.X_Final) Then
                        'Creo las series
                        x_T_i = (NumericUpDown_Dato_1.Value)
                        y_T_i = Datos_Registro.Tables(0).Rows(x_T_i * Registro_Frecuencia - Datos_Registro.Tables(0).Rows(0)(0))(1)
                        'Adiciono las series a la grafica
                        'Actualiza Series_Max Para que se vea al frente
                        Chart_Registro_Parcial.Series.Add(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_i")
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_i").ChartType = DataVisualization.Charting.SeriesChartType.Point
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_i").Points.AddXY(x_T_i, y_T_i)
                        '  Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_i").MarkerImage = "C:\Users\Frank\Dropbox\Dropbox\Bohíque_FMS\Bohíque_FMS\Imagenes\" + TreeView_Graficar.Nodes(Index_TreeView_0).Nodes(Index_TreeView_1).ImageKey
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_i").Color = Color.Red
                    End If
                    If NumericUpDown_Dato_2.Text <> "" And ((NumericUpDown_Dato_2.Value) > Zoom.X_Inicio And (NumericUpDown_Dato_2.Value) < Zoom.X_Final) Then
                        'Creo las series
                        x_T = (NumericUpDown_Dato_2.Value)
                        y_T = Datos_Registro.Tables(0).Rows(x_T * Registro_Frecuencia - Datos_Registro.Tables(0).Rows(0)(0))(1)
                        'Adiciono las series a la grafica
                        'Actualiza Series_Max Para que se vea al frente
                        Chart_Registro_Parcial.Series.Add(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T")
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T").ChartType = DataVisualization.Charting.SeriesChartType.Point
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T").Points.AddXY(x_T, y_T)
                        '  Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T").MarkerImage = "C:\Users\Frank\Dropbox\Dropbox\Bohíque_FMS\Bohíque_FMS\Imagenes\" + TreeView_Graficar.Nodes(Index_TreeView_0).Nodes(Index_TreeView_1).ImageKey
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T").Color = Color.Black

                    End If
                    If NumericUpDown_Dato_3.Text <> "" And ((NumericUpDown_Dato_3.Value) > Zoom.X_Inicio And (NumericUpDown_Dato_3.Value) < Zoom.X_Final) Then
                        'Creo las series
                        x_T_f = (NumericUpDown_Dato_3.Value)
                        y_T_f = Datos_Registro.Tables(0).Rows(x_T_f * Registro_Frecuencia - Datos_Registro.Tables(0).Rows(0)(0))(1)
                        'Adiciono las series a la grafica
                        'Actualiza Series_Max Para que se vea al frente
                        Chart_Registro_Parcial.Series.Add(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_f")
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_f").ChartType = DataVisualization.Charting.SeriesChartType.Point
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_f").Points.AddXY(x_T_f, y_T_f)
                        '  Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_f").MarkerImage = "C:\Users\Frank\Dropbox\Dropbox\Bohíque_FMS\Bohíque_FMS\Imagenes\" + TreeView_Graficar.Nodes(Index_TreeView_0).Nodes(Index_TreeView_1).ImageKey
                        Chart_Registro_Parcial.Series(Registro_Tabla + "___" + Registro_Columna + "___Complejo_QRS" + "T_f").Color = Color.Blue
                    End If
                End If
    ...
    Private Sub Chart_Registro_Parcial_MouseDown(sender As Object, e As MouseEventArgs) Handles Chart_Registro_Parcial.MouseDown
        If e.Button = MouseButtons.Left Then
            ...
            Else
                ...
                If Registro_Modificar_1.Tipo_Onda = Onda_P Or Registro_Modificar_1.Tipo_Onda = Onda_T Then
                    If Resta_Num_1 <= Resta_Num_2 And Resta_Num_1 <= Resta_Num_3 Then
                        Modificar_Puntos = 1
                    ElseIf Resta_Num_2 < Resta_Num_1 And Resta_Num_2 <= Resta_Num_3 Then
                        Modificar_Puntos = 2
                    Else
                        Modificar_Puntos = 3
                    End If
    ...
    Private Sub Button_Actualizar_Click(sender As Object, e As EventArgs) Handles Button_Actualizar.Click
        ...
        If Registro_Modificar_1.Accion_Modificar Then
            ...
            End If
            If Registro_Modificar_1.Tipo_Onda = Onda_P Or Registro_Modificar_1.Tipo_Onda = Onda_T Then
                'Verifico que los puntos P_i,P,P_f y T_i,T,T_f siguna en ese orden
                If NumericUpDown_Dato_1.Value < NumericUpDown_Dato_2.Value Then
                    If NumericUpDown_Dato_2.Value < NumericUpDown_Dato_3.Value Then
                        'Mofico el dato
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(1, Registro_Modificar_1.Ubicacion_Tabla_Referencia).Value = NumericUpDown_Dato_1.Value
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(2, Registro_Modificar_1.Ubicacion_Tabla_Referencia).Value = NumericUpDown_Dato_2.Value
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(3, Registro_Modificar_1.Ubicacion_Tabla_Referencia).Value = NumericUpDown_Dato_3.Value
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(4, Registro_Modificar_1.Ubicacion_Tabla_Referencia).Value = ComboBox_Tipo_Onda_Modificar.Text
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar.Rows(Registro_Modificar_1.Ubicacion_Tabla_Referencia).DefaultCellStyle.BackColor = Color.Yellow
            ...
            If Registro_Modificar_1.Tipo_Onda = Onda_P Or Registro_Modificar_1.Tipo_Onda = Onda_T Then
                ...
                If NumericUpDown_Dato_1.Value < NumericUpDown_Dato_2.Value Then
                    If NumericUpDown_Dato_2.Value < NumericUpDown_Dato_3.Value Then
                        ...
                        Dim Temp_Row As DataRow = Tabla.NewRow()
                        Dim Pocision_DataGridView As Int32
                        If NumericUpDown_Dato_1.Value < UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(3, Registro_Modificar_1.Ubicacion_Tabla_Referencia).Value Then
                            Tabla.Rows.InsertAt(Temp_Row, Registro_Modificar_1.Ubicacion_Tabla_Referencia)
                            Pocision_DataGridView = Registro_Modificar_1.Ubicacion_Tabla_Referencia
                        Else
                            Tabla.Rows.InsertAt(Temp_Row, Registro_Modificar_1.Ubicacion_Tabla_Referencia + 1)
                        ...
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(2, Pocision_DataGridView).Value = NumericUpDown_Dato_2.Value
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(3, Pocision_DataGridView).Value = NumericUpDown_Dato_3.Value
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar(4, Pocision_DataGridView).Value = ComboBox_Tipo_Onda_Modificar.Text
                        'Modificao el color de la fila para remarcar que se agrega un nuevo dato 
                        UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar.Rows(Pocision_DataGridView).DefaultCellStyle.BackColor = Color.Green
                        'No se actaulizo el indice por que se demora mucho el procedimiento segun el seiguiente algoritmo
                        'For Index = 0 To UserControl_Modulo_Graficar_Invocador.DataGridView_Registro_Modificar.Rows.Count - 1
