...
Public Class UserControl_Modulo_Graficar
        ...
        For Index = 0 To (Registro_Parciales_Graficados.Count - 1)
            If Registro_Parciales_Graficados(Index).Nombre_Tabla + "___" + Registro_Parciales_Graficados(Index).Nombre_Columna = ComboBox_Registro_Modificar.Text Then
                ...
                If (TabControlEX_Selecion_Ondas_Intervalos.TabPages(TabControlEX_Selecion_Ondas_Intervalos.SelectedIndex).Name = "TabPageEX_Ondas") Then
                    ...
                    If RadioButton_P.Checked And Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Registro, Registro_Tabla + "___Onda_P") Then
                        Dim Datos_Lectura_Registro_QRS, Datos_Lectura_Puntero As DataSet
                        Dim Tabla_Datos As New DataTable()
                        Dim Puntero As Int64 = 1
                        Dim Puntero_Pi As Double
                        Dim Puntero_P As Double
                        Dim Puntero_P_f As Double
                        Dim Tipo_QRS As String = "Flat_Wave"
                        Tabla_Datos.Columns.Add(New DataColumn("0", GetType(System.Int32)))
                        Tabla_Datos.Columns.Add(New DataColumn("P_i", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("P", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("P_f", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("P_Type", GetType(System.String)))


                        Datos_Lectura_Registro_QRS = Class_Funciones_Base_Datos.Registros_Consultar_Tabla_Completa(Coneccion_Registro, Registro_Tabla + "___Onda_P", " P_i", "P_f", Convert.ToString(Tabla_Valor_Min * Registro_Frecuencia), Convert.ToString(Tabla_Valor_Max * Registro_Frecuencia))
                        For Index1 = 0 To Datos_Lectura_Registro_QRS.Tables(0).Rows.Count - 1
                            ...
                            Puntero_Pi = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(1) / Registro_Frecuencia, Double)
                            Puntero_P = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(2) / Registro_Frecuencia, Double)
                            Puntero_P_f = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(3) / Registro_Frecuencia, Double)
                            If Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 0 Then
                                Tipo_QRS = "Flat_Wave"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 1 Then
                                Tipo_QRS = "Wave_P"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 2 Then
                                Tipo_QRS = "Wave_N"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 3 Then
                                Tipo_QRS = "Wave_B_PP_N"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 4 Then
                                Tipo_QRS = "Wave_B_P_N"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 5 Then
                                Tipo_QRS = "Wave_B_P_NN"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 6 Then
                                Tipo_QRS = "Wave_B_NN_P"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 7 Then
                                Tipo_QRS = "Wave_B_N_P"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 8 Then
                                Tipo_QRS = "Wave_B_N_PP"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 9 Then
                                Tipo_QRS = "Wave_C_P"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 10 Then
                                Tipo_QRS = "Wave_C_N"
                            End If
                            Tabla_Datos.Rows.Add(Puntero, Puntero_Pi, Puntero_P, Puntero_P_f, Tipo_QRS)
                        Next
                    ...
                    If RadioButton_QRS.Checked And Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Registro, Registro_Tabla + "___Complejo_QRS") Then
                        ...
                        Tabla_Datos.Columns.Add(New DataColumn("QRS_Type", GetType(System.String)))
                        ...
                        Panel_Color_Registro_Modificar.BackColor = Registro_Parciales_Graficados(Index).Color
                    End If
                    If RadioButton_T.Checked And Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Registro, Registro_Tabla + "___Onda_T") Then
                        Dim Datos_Lectura_Registro_QRS, Datos_Lectura_Puntero As DataSet
                        Dim Tabla_Datos As New DataTable()
                        Dim Puntero As Int64 = 1
                        Dim Puntero_Ti As Double
                        Dim Puntero_T As Double
                        Dim Puntero_T_f As Double
                        Dim Tipo_QRS As String = "Flat_Wave"
                        Tabla_Datos.Columns.Add(New DataColumn("0", GetType(System.Int32)))
                        Tabla_Datos.Columns.Add(New DataColumn("T_i", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("T", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("T_f", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("T_Type", GetType(System.String)))


                        Datos_Lectura_Registro_QRS = Class_Funciones_Base_Datos.Registros_Consultar_Tabla_Completa(Coneccion_Registro, Registro_Tabla + "___Onda_T", " T_i", "T_f", Convert.ToString(Tabla_Valor_Min * Registro_Frecuencia), Convert.ToString(Tabla_Valor_Max * Registro_Frecuencia))
                        For Index1 = 0 To Datos_Lectura_Registro_QRS.Tables(0).Rows.Count - 1
                            Puntero = Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(0)
                            Puntero_Ti = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(1) / Registro_Frecuencia, Double)
                            Puntero_T = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(2) / Registro_Frecuencia, Double)
                            Puntero_T_f = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(3) / Registro_Frecuencia, Double)
                            If Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 0 Then
                                Tipo_QRS = "Flat_Wave"
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 1 Then
                                Tipo_QRS = "Wave_P"
                            ...
                            ElseIf Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(4) = 10 Then
                                Tipo_QRS = "Wave_C_N"
                            End If
                            Tabla_Datos.Rows.Add(Puntero, Puntero_Ti, Puntero_T, Puntero_T_f, Tipo_QRS)
                        Next
                        DataGridView_Registro_Modificar.DataSource = Tabla_Datos
                ...
                ElseIf (TabControlEX_Selecion_Ondas_Intervalos.TabPages(TabControlEX_Selecion_Ondas_Intervalos.SelectedIndex).Name = "TabPageEX_Intervalos") Then
                    ...
                    If RadioButton_P_R.Checked And Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Registro, Registro_Tabla + "___Intervalo_P_R") Then
                        Dim Datos_Lectura_Registro_QRS, Datos_Lectura_Puntero As DataSet
                        Dim Tabla_Datos As New DataTable()
                        Dim Puntero As Int64 = 1
                        Dim Inicio_P_R As Double
                        Dim Final_P_R As Double
                        Dim Duracion_P_R As Double
                        Tabla_Datos.Columns.Add(New DataColumn("0", GetType(System.Int32)))
                        Tabla_Datos.Columns.Add(New DataColumn("Start P_R", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("End P_R", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("Duration P_R", GetType(System.Double)))

                        Datos_Lectura_Registro_QRS = Class_Funciones_Base_Datos.Registros_Consultar_Tabla_Completa(Coneccion_Registro, Registro_Tabla + "___Intervalo_P_R", "Inicio_P_R", "Final_P_R", Convert.ToString(Tabla_Valor_Min * Registro_Frecuencia), Convert.ToString(Tabla_Valor_Max * Registro_Frecuencia))
                        For Index1 = 0 To Datos_Lectura_Registro_QRS.Tables(0).Rows.Count - 1
                            Puntero = Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(0)
                            Inicio_P_R = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(1) / Registro_Frecuencia, Double)
                            Final_P_R = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(2) / Registro_Frecuencia, Double)
                            Duracion_P_R = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(3) / Registro_Frecuencia, Double)
                            Tabla_Datos.Rows.Add(Puntero, Inicio_P_R, Final_P_R, Duracion_P_R)
                        Next
                        DataGridView_Registro_Modificar.DataSource = Tabla_Datos
                    ...
                    If RadioButton_R_R.Checked And Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Registro, Registro_Tabla + "___Intervalo_R_R") Then
                        ...
                        Panel_Color_Registro_Modificar.BackColor = Registro_Parciales_Graficados(Index).Color
                    End If
                    If RadioButton_Q_T.Checked And Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Registro, Registro_Tabla + "___Intervalo_Q_T") Then
                        Dim Datos_Lectura_Registro_QRS, Datos_Lectura_Puntero As DataSet
                        Dim Tabla_Datos As New DataTable()
                        Dim Puntero As Int64 = 1
                        Dim Inicio_Q_T As Double
                        Dim Final_Q_T As Double
                        Dim Duracion_Q_T As Double
                        Tabla_Datos.Columns.Add(New DataColumn("0", GetType(System.Int32)))
                        Tabla_Datos.Columns.Add(New DataColumn("Start Q_T", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("End Q_T", GetType(System.Double)))
                        Tabla_Datos.Columns.Add(New DataColumn("Duration Q_T", GetType(System.Double)))

                        Datos_Lectura_Registro_QRS = Class_Funciones_Base_Datos.Registros_Consultar_Tabla_Completa(Coneccion_Registro, Registro_Tabla + "___Intervalo_Q_T", "Inicio_Q_T", "Final_Q_T", Convert.ToString(Tabla_Valor_Min * Registro_Frecuencia), Convert.ToString(Tabla_Valor_Max * Registro_Frecuencia))
                        For Index1 = 0 To Datos_Lectura_Registro_QRS.Tables(0).Rows.Count - 1
                            Puntero = Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(0)
                            Inicio_Q_T = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(1) / Registro_Frecuencia, Double)
                            Final_Q_T = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(2) / Registro_Frecuencia, Double)
                            Duracion_Q_T = CType(Datos_Lectura_Registro_QRS.Tables(0).Rows(Index1)(3) / Registro_Frecuencia, Double)
                            Tabla_Datos.Rows.Add(Puntero, Inicio_Q_T, Final_Q_T, Duracion_Q_T)
                        Next
                        DataGridView_Registro_Modificar.DataSource = Tabla_Datos
        ...
        If Registro_Parciales_Graficados.Count > 0 Then
            ...
            For Index = 0 To (Registro_Parciales_Graficados.Count - 1)
                ...
                If Form_Principal.Estado_Registros.Consultar_Registro_Bloqueado(Registro_Parciales_Graficados(Index).Nombre_Tabla) = False Then
                    ...
                    End If
                    '-------------------------------------------------------------------------------------------------------
                    'Graficar trasnsformada Wavelet si esta activada y existe del Busqueda de las ondas PT
                    '-------------------------------------------------------------------------------------------------------
                    If CheckBox_Trasformada_Wavelet_Busqueda_Onda_PT.Checked And My.Computer.FileSystem.FileExists(Class_Funciones_Base_Datos.Direccion_Base_Datos + "\" + Registro_Tabla + "___" + Registro_Columna + "___Transformada_Wavelet_Onda_PT_Busqueda_Temp.mdf") Then
                        Dim Coneccion_Base_Datos_Transformada_Wavelet_Onda_PT_Busqueda_Temp As New SqlConnection
                        Dim Tabla_Transformada_Wavelet_Onda_PT_Busqueda As String = Registro_Tabla + "___" + Registro_Columna + "___Transformada_Wavelet_Onda_PT_Busqueda_Temp"
                        ...
                        If Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Base_Datos_Transformada_Wavelet_Onda_PT_Busqueda_Temp, Registro_Tabla + "___" + Registro_Columna + "___Transformada_Wavelet_Onda_PT_Busqueda_Temp") Then
                            Dim Rojo, Verde, Azul As Integer
                            Rojo = Chart_Registro_Parcial.Series(Registros_Selecionados).Color.R
                            Verde = Chart_Registro_Parcial.Series(Registros_Selecionados).Color.G
                            Azul = Chart_Registro_Parcial.Series(Registros_Selecionados).Color.B
                            ...
                            Dim Datos_Transformada_Wavelet As New DataSet
                            Datos_Transformada_Wavelet = Class_Funciones_Base_Datos.Registro_Consultar(Coneccion_Base_Datos_Transformada_Wavelet_Onda_PT_Busqueda_Temp, Tabla_Transformada_Wavelet_Onda_PT_Busqueda, Registro_Columna, Paso_Registro, Convert.ToString(Math.Floor(Intervalo_Min_X * Registro_Frecuencia)), Convert.ToString(Math.Ceiling(Intervalo_Max_X * Registro_Frecuencia)))
                            For Index1 = 0 To Datos_Transformada_Wavelet.Tables(0).Rows.Count - 1
                                y(Index1) = Datos_Transformada_Wavelet.Tables(0).Rows(Index1)(1)
                                x(Index1) = (Datos_Transformada_Wavelet.Tables(0).Rows(Index1)(0) * Paso_Registro) / Registro_Frecuencia
                            Next Index1
                            ...
                            End If
                            'Agregar el nuevo registro(Una nueva serie) a la Grafica parcial 
                            Registros_Selecionados = Registro_Columna + "___" + Registro_Tabla + "___Transformada_Wavelet_Onda_PT_Busqueda_Temp"
                            If Registros_Selecionados.Count > 0 Then
                                Chart_Registro_Parcial.Series.Add(Registros_Selecionados)
                                'Especifica El color 
                                Chart_Registro_Parcial.Series(Registros_Selecionados).Color = Color.BlueViolet
                    ...
                    End If
                    '-------------------------------------------------------------------------------------------------------
                    'Graficar trasnsformada Wavelet si esta activada y existe del Correcion de las ondas PT
                    '-------------------------------------------------------------------------------------------------------
                    If CheckBox_Habilitar_Trasformada_Wavelet_Correccion_Onda_PT.Checked And My.Computer.FileSystem.FileExists(Class_Funciones_Base_Datos.Direccion_Base_Datos + "\" + Registro_Tabla + "___" + Registro_Columna + "___Transformada_Wavelet_Onda_PT_Correcion_Temp.mdf") Then
                        Dim Coneccion_Base_Datos_Transformada_Wavelet_Onda_PT_Correcion_Temp As New SqlConnection
                        Dim Tabla_Transformada_Wavelet_Onda_PT_Correcion As String = Registro_Tabla + "___" + Registro_Columna + "___Transformada_Wavelet_Onda_PT_Correcion_Temp"
                        ...
                        If Class_Funciones_Base_Datos.Registro_Existe(Coneccion_Base_Datos_Transformada_Wavelet_Onda_PT_Correcion_Temp, Registro_Tabla + "___" + Registro_Columna + "___Transformada_Wavelet_Onda_PT_Correcion_Temp") Then
                            Dim Rojo, Verde, Azul As Integer
                            Rojo = Chart_Registro_Parcial.Series(Registros_Selecionados).Color.R
                            Verde = Chart_Registro_Parcial.Series(Registros_Selecionados).Color.G
                            Azul = Chart_Registro_Parcial.Series(Registros_Selecionados).Color.B
                            ...
                            Dim Datos_Transformada_Wavelet As New DataSet
                            Datos_Transformada_Wavelet = Class_Funciones_Base_Datos.Registro_Consultar(Coneccion_Base_Datos_Transformada_Wavelet_Onda_PT_Correcion_Temp, Tabla_Transformada_Wavelet_Onda_PT_Correcion, Registro_Columna, Paso_Registro, Convert.ToString(Math.Floor(Intervalo_Min_X * Registro_Frecuencia)), Convert.ToString(Math.Ceiling(Intervalo_Max_X * Registro_Frecuencia)))
                            For Index1 = 0 To Datos_Transformada_Wavelet.Tables(0).Rows.Count - 1
                                y(Index1) = Datos_Transformada_Wavelet.Tables(0).Rows(Index1)(1)
                                x(Index1) = (Datos_Transformada_Wavelet.Tables(0).Rows(Index1)(0) * Paso_Registro) / Registro_Frecuencia
                            Next Index1
                            ...
                            End If
                            'Agregar el nuevo registro(Una nueva serie) a la Grafica parcial 
                            Registros_Selecionados = Registro_Columna + "___" + Registro_Tabla + "___Transformada_Wavelet_Onda_PT_Correcion_Temp"
                            If Registros_Selecionados.Count > 0 Then
                                Chart_Registro_Parcial.Series.Add(Registros_Selecionados)
                                'Especifica El color 
                                Chart_Registro_Parcial.Series(Registros_Selecionados).Color = Color.Blue
    ...
    Private Sub UserControl_Modulo_Graficar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ComboBox_Escala_Tiempo.SelectedIndex = 0
    ...
    Private Sub ComboBox_Registro_Graficado_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox_Registro_Graficado.SelectedIndexChanged
        ...
        For Index = 0 To (Registro_Parciales_Graficados.Count - 1)
            If Registro_Parciales_Graficados(Index).Nombre_Tabla + "___" + Registro_Parciales_Graficados(Index).Nombre_Columna = ComboBox_Registro_Graficado.Text Then
                ...
                Datos_Paciente = Datos_Paciente + "Date of Birth:" + Chr(13) + Fecha_Nacimiento_Dia + "/" + Fecha_Nacimiento_Mes + "/" + Fecha_Nacimiento_Año + Chr(13)
                ...
                Datos_Paciente = Datos_Paciente + "Mark Pass:" + Chr(13) + Marca_Paso + Chr(13)
                Datos_Paciente = Datos_Paciente + "Details Patient:" + Chr(13) + Detalles_Paciente + Chr(13)
    ...
    Private Sub RadioButton_QRS_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton_QRS.CheckedChanged
        ...
        End If
    End Sub
    Private Sub RadioButton_T_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton_T.CheckedChanged
        If RadioButton_T.Checked Then
            Actualizar_Tabla_DataGridView_Registro_Modificar()
        End If
        ...
        If Filas_Selecionadas.Count = 1 Then
            ...
            For Index = 0 To (Registro_Parciales_Graficados.Count - 1)
                If Registro_Parciales_Graficados(Index).Nombre_Tabla + "___" + Registro_Parciales_Graficados(Index).Nombre_Columna = ComboBox_Registro_Modificar.Text Then
                    ...
                    If RadioButton_P.Checked Then
                        Tabla_Consulta = Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_P"
                    End If
                    If RadioButton_QRS.Checked Then
                        Tabla_Consulta = Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Complejo_QRS"
                    End If
                    If RadioButton_T.Checked Then
                        Tabla_Consulta = Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_T"
                    End If
            ...
            If RadioButton_P.Checked Then
                Modificar_Uvicacion_Onda.Form_Registro_Parciales_Modificar(Me.ParentForm, Me, True, 0, RowIndex, Class_Analisis_Registro.Tipo_Onda_P_QRS_T_To_int(DataGridView_Registro_Modificar(DataGridView_Registro_Modificar.Columns.Count - 1, RowIndex).Value), DataGridView_Registro_Modificar(1, RowIndex).Value, DataGridView_Registro_Modificar(2, RowIndex).Value, DataGridView_Registro_Modificar(3, RowIndex).Value)
            End If
            If RadioButton_QRS.Checked Then
            ...
            End If
            If RadioButton_T.Checked Then
                Modificar_Uvicacion_Onda.Form_Registro_Parciales_Modificar(Me.ParentForm, Me, True, 2, RowIndex, Class_Analisis_Registro.Tipo_Onda_P_QRS_T_To_int(DataGridView_Registro_Modificar(DataGridView_Registro_Modificar.Columns.Count - 1, RowIndex).Value), DataGridView_Registro_Modificar(1, RowIndex).Value, DataGridView_Registro_Modificar(2, RowIndex).Value, DataGridView_Registro_Modificar(3, RowIndex).Value)
            End If
        End If
    ...
    Private Sub Agregar_Punto_Click(sender As Object, e As EventArgs) Handles Button_Agregar_Punto.Click
        ...
        If Filas_Selecionadas.Count = 2 Or Filas_Selecionadas.Count = 1 Then
            ...
            'LLamar el for modificar segun el tioppo de onda  que se ba a modificar
            If RadioButton_P.Checked Then
                Modificar_Uvicacion_Onda.Form_Registro_Parciales_Modificar(Me.ParentForm, Me, False, 0, RowIndex,, Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X + 0.9 * (Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Max_X - Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X) / 2, Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X + 0.5 * (Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Max_X - Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X) / 2, Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X + 0.1 * (Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Max_X - Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X) / 2)
            End If
            If RadioButton_QRS.Checked Then
            ...
            End If
            If RadioButton_T.Checked Then
                Modificar_Uvicacion_Onda.Form_Registro_Parciales_Modificar(Me.ParentForm, Me, False, 2, RowIndex,, Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X + 0.9 * (Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Max_X - Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X) / 2, Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X + 0.5 * (Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Max_X - Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X) / 2, Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X + 0.1 * (Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Max_X - Modificar_Uvicacion_Onda.Registro_Modificar_1.Intervalo_Min_X) / 2)
            End If
        ...
        For Index = 0 To (Registro_Parciales_Graficados.Count - 1)
            If Registro_Parciales_Graficados(Index).Nombre_Tabla + "___" + Registro_Parciales_Graficados(Index).Nombre_Columna = ComboBox_Registro_Modificar.Text Then
                ...
                If RadioButton_P.Checked Then
                    ...
                    Tabla_Datos.Columns.Add(New DataColumn("P_i", GetType(System.Int32)))
                    Tabla_Datos.Columns.Add(New DataColumn("P", GetType(System.Int32)))
                    Tabla_Datos.Columns.Add(New DataColumn("P_f", GetType(System.Int32)))
                    Tabla_Datos.Columns.Add(New DataColumn("Tipo_Onda_P", GetType(System.Int32)))
                    Dim Tabla_Almacenamiento_Resultados As String = Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_P_Temp"
                    ...
                    '------------------------------------------------
                    Class_Funciones_Base_Datos.Registros_Crear_Tabla_Onda_P(Coneccion_Registro, Tabla_Almacenamiento_Resultados)
                    '------------------------------------------------
                    'Guardar dese el inicio del registro asta llegar al inicio del la tabla temp
                    '------------------------------------------------
                    Datos_Tabla = Class_Funciones_Base_Datos.Registro_Consultar(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_P", "P_i, P, P_f,Tipo_Onda_P", Convert.ToString(0), Convert.ToString(DataGridView_Registro_Valor_Min - 1))
                    For Index1 = 0 To Datos_Tabla.Tables(0).Rows.Count - 1
                        Tabla_Datos.Rows.Add(Puntero, Datos_Tabla.Tables(0).Rows(Index1)(1), Datos_Tabla.Tables(0).Rows(Index1)(2), Datos_Tabla.Tables(0).Rows(Index1)(3), Datos_Tabla.Tables(0).Rows(Index1)(4))
                    ...
                    '------------------------------------------------
                    For Index1 = 0 To DataGridView_Registro_Modificar.Rows.Count - 2
                        Tabla_Datos.Rows.Add(Puntero, DataGridView_Registro_Modificar(1, Index1).Value * frecuencia, DataGridView_Registro_Modificar(2, Index1).Value * frecuencia, DataGridView_Registro_Modificar(3, Index1).Value * frecuencia, Class_Analisis_Registro.Tipo_Onda_P_QRS_T_To_int(DataGridView_Registro_Modificar(4, Index1).Value))
                        '------------------------------------------------
                    ...
                    '------------------------------------------------
                    Datos_Tabla = Class_Funciones_Base_Datos.Registro_Consultar(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_P", "P_i, P, P_f,Tipo_Onda_P", Convert.ToString(DataGridView_Registro_Valor_Max + 1), Class_Funciones_Base_Datos.Registro_Maximo_Valor_Puntero(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_P"))
                    For Index1 = 0 To Datos_Tabla.Tables(0).Rows.Count - 1
                        Tabla_Datos.Rows.Add(Puntero, Datos_Tabla.Tables(0).Rows(Index1)(1), Datos_Tabla.Tables(0).Rows(Index1)(2), Datos_Tabla.Tables(0).Rows(Index1)(3), Datos_Tabla.Tables(0).Rows(Index1)(4))
                        If Puntero Mod Max_Datos_Almacenar = 0 Then
                            '------------------------------------------------
                    ...
                    If Tabla_Datos.Rows.Count > 0 Then
                        ...
                        Tabla_Datos.AcceptChanges()
                    End If
                    Class_Funciones_Base_Datos.Registros_Eliminar_Registro(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_P")
                    Class_Funciones_Base_Datos.Registros_Renombrar_Registro(Coneccion_Registro, Tabla_Almacenamiento_Resultados, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_P")
                End If
                If RadioButton_QRS.Checked Then
                    Dim frecuencia As Int64 = Registro_Parciales_Graficados(Index).Frecuencia
                    Dim Tabla_Datos As New DataTable()
                    ...
                    Dim Tabla_Datos As New DataTable()
                    Tabla_Datos.Columns.Add(New DataColumn("Puntero", GetType(System.Int32)))
                    Tabla_Datos.Columns.Add(New DataColumn("T_i", GetType(System.Int32)))
                    Tabla_Datos.Columns.Add(New DataColumn("T", GetType(System.Int32)))
                    Tabla_Datos.Columns.Add(New DataColumn("T_f", GetType(System.Int32)))
                    Tabla_Datos.Columns.Add(New DataColumn("Tipo_Onda_T", GetType(System.Int32)))
                    Dim Tabla_Almacenamiento_Resultados As String = Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_T_Temp"
                    Class_Funciones_Base_Datos.Registros_Eliminar_Registro(Coneccion_Registro, Tabla_Almacenamiento_Resultados)
                    '------------------------------------------------
                    'Ordeno el DataGridView por la primera columna diferente de Puntero
                    '------------------------------------------------
                    ...
                    Class_Funciones_Base_Datos.Registros_Crear_Tabla_Onda_T(Coneccion_Registro, Tabla_Almacenamiento_Resultados)

                    '------------------------------------------------
                    'Guardar dese el inicio del registro asta llegar al inicio del la tabla temp
                    '------------------------------------------------

                    Datos_Tabla = Class_Funciones_Base_Datos.Registro_Consultar(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_T", "T_i, T, T_f,Tipo_Onda_T", Convert.ToString(0), Convert.ToString(DataGridView_Registro_Valor_Min - 1))
                    For Index1 = 0 To Datos_Tabla.Tables(0).Rows.Count - 1
                        Tabla_Datos.Rows.Add(Puntero, Datos_Tabla.Tables(0).Rows(Index1)(1), Datos_Tabla.Tables(0).Rows(Index1)(2), Datos_Tabla.Tables(0).Rows(Index1)(3), Datos_Tabla.Tables(0).Rows(Index1)(4))
                        If Puntero Mod Max_Datos_Almacenar = 0 Then
                            Class_Funciones_Base_Datos.Registro_Almacenar_Datos(Coneccion_Registro, Tabla_Almacenamiento_Resultados, Tabla_Datos)
                    ...
                    'Guardar del final de la tabla al final de registro
                    '------------------------------------------------
                    Datos_Tabla = Class_Funciones_Base_Datos.Registro_Consultar(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_T", "T_i, T, T_f,Tipo_Onda_T", Convert.ToString(DataGridView_Registro_Valor_Max + 1), Class_Funciones_Base_Datos.Registro_Maximo_Valor_Puntero(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_T"))
                    For Index1 = 0 To Datos_Tabla.Tables(0).Rows.Count - 1
                        Tabla_Datos.Rows.Add(Puntero, Datos_Tabla.Tables(0).Rows(Index1)(1), Datos_Tabla.Tables(0).Rows(Index1)(2), Datos_Tabla.Tables(0).Rows(Index1)(3), Datos_Tabla.Tables(0).Rows(Index1)(4))
                        If Puntero Mod Max_Datos_Almacenar = 0 Then
                            '------------------------------------------------
                    ...
                    If Tabla_Datos.Rows.Count > 0 Then
                        ...
                        Tabla_Datos.AcceptChanges()
                    End If
                    Class_Funciones_Base_Datos.Registros_Eliminar_Registro(Coneccion_Registro, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_T")
                    Class_Funciones_Base_Datos.Registros_Renombrar_Registro(Coneccion_Registro, Tabla_Almacenamiento_Resultados, Registro_Parciales_Graficados(Index).Nombre_Tabla + "___Onda_T")
    ...
    Private Sub RadioButton_P_R_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton_P_R.CheckedChanged
        If RadioButton_P_R.Checked Then
            Actualizar_Tabla_DataGridView_Registro_Modificar()
        End If
    End Sub
    ...
    Private Sub RadioButton_Q_T_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton_Q_T.CheckedChanged
        If RadioButton_Q_T.Checked Then
            Actualizar_Tabla_DataGridView_Registro_Modificar()
        End If
    End Sub
    ...
    Private Sub CheckBox_Trasformada_Wavelet_Busqueda_Onda_PT_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox_Trasformada_Wavelet_Busqueda_Onda_PT.CheckedChanged
        Actualizar_Registro_Parcial()
    End Sub

    Private Sub CheckBox_Habilitar_Trasformada_Wavelet_Correccion_Onda_PT_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox_Habilitar_Trasformada_Wavelet_Correccion_Onda_PT.CheckedChanged
        Actualizar_Registro_Parcial()
    End Sub
